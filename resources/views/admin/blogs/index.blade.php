...
{{-- <img src="public/images/admin/L19Lr0I9h80Y63DLhpBHWOFTx0V445nTF3BGgl7J.png" alt=""> --}}
            ...
            <table class="table-auto w-full">
                ...
                <tr class="text-sm bg-gray-50">
                    <td class="flex px-4 py-3 items-center">
                        ...
                        {{-- <img class="w-12 h-12 mr-4 object-cover rounded-md" src="{{ asset('storage/exetDo2ceYbXiwnLk7gYg4xA3cZCOnCjTd5goJ2O.png')}}" alt=""> --}}
                        {{-- <img class="w-12 h-12 mr-4 object-cover rounded-md" src="admin/L19Lr0I9h80Y63DLhpBHWOFTx0V445nTF3BGgl7J.png" alt=""> --}}

                        <p class="font-medium"><a href="{{ route('admin.blogs.edit', ['blog' => $blog->id]) }}">{{ $blog->title }}</a></p>
                    </td>
                    <td class="font-medium">{{ $blog->category->name }}</td>
                    <td class="font-medium">店長</td>
                    <td>{{ $blog->updated_at }}</td>
                    <td>
                        <div>
                            <a class="inline-block mr-2" href="{{ route('admin.blogs.edit', ['blog' => $blog]) }}">
